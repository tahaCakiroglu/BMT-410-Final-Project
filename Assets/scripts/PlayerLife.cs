...
public class PlayerLife : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision) 
    {
        ...
        {
            // bool Rigidbody.isKinematic : Fiziðin katý gövdeyi etkileyip etkilemediðini kontrol eder.
    ...
    // PlayerDead fonksiyonu ile kiþi ölünce sound efekti gelir ve leveli reloadlar.
    private void PlayerDead()
    {
        ...
        // Invoke : Kendi timer'i sýfýrlar ve leveli reloadlar.
        Invoke(nameof(ReloadLevel), 1f);
    }

    private void ReloadLevel()
    {
        SceneManager.LoadScene(SceneManager.GetActiveScene().name); // Sahne adýný dinamik olarak deðiþtiriyoruz.
    }
